...
EmptyPage {
    ...
    GridView {
        ...
        readonly property int columns: root.isAppMode ? 11 : Math.floor(root.parentAvailableWidth / kickoff.minimumFileGridWidth)
        readonly property int rows: root.maximumRows > 0 ? Math.min(root.maximumRows, 6) : 6
