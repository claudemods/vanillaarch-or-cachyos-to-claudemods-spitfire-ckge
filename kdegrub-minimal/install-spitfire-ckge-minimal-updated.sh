...
echo -e "${CYAN}"
echo "           claudemods Vanilla Arch Kde Grub to Spitfire CKGE Minimal v1.02 16-11-2025"
echo -e "${NC}"
echo "================================================================================"
echo ""
...
cd /home/$USER && wget --show-progress --no-check-certificate --continue --tries=10 --timeout=30 --waitretry=5 https://claudemodsreloaded.co.uk/claudemods-desktop/spitfire-minimal.zip
...
sudo rm -rf /home/$USER/spitfire-minimal.zip
